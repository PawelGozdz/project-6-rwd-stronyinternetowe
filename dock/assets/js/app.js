...
(0, _jquery2.default)('#contact-form')

// form validation passed, form will submit if submit event not returned false
.on("invalid.zf.abide", function (ev, elem) {
  (0, _sweetalert2.default)('Coś nie tak', 'Sprawdź czy wszystkie pola zostały wypełnione', 'error');
}).on("formvalid.zf.abide", function (ev, frm) {
  ...
  _jquery2.default.ajax({
    ...
    success: function success(data) {
      ...
      (0, _sweetalert2.default)(response.message, 'Dziękuję ' + response.name + ' za Twoją wiadomość!', 'success');
    }
  });
})
// to prevent form from submitting upon successful validation
...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)(document).on('scroll', function () {
    ...
    if ((0, _jquery2.default)(window).scrollTop() > 800) {
      (0, _jquery2.default)('.arrow').addClass('show');
    } else {
      (0, _jquery2.default)('.arrow').removeClass('show');
    }
  });
});
